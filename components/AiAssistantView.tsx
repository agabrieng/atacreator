...
import type { AtaData, Projeto, AdminSettings, Webhook } from '../types';
import { BrainCircuitIcon, SendIcon, AlertTriangleIcon, Share2Icon, FilePdfIcon, CopyIcon, UsersIcon, CheckIcon, XIcon } from './icons';
...
const AiAssistantView: React.FC<AiAssistantViewProps> = ({ adminSettings, webhooks }) => {
    ...
    return (
        <div className="flex flex-col h-full">
            <header className="p-4 md:p-8 border-b border-slate-200 dark:border-slate-700">
                <h1 className="text-3xl font-bold text-slate-800 dark:text-slate-100 flex items-center">
                    <BrainCircuitIcon className="w-8 h-8 mr-3 text-slate-500" />
                    Assistente IA Claritas
                </h1>
                <p className="text-slate-500 dark:text-slate-400">Converse com seus dados e obtenha insights instantâneos.</p>
            </header>
            ...
            <footer className="p-4 md:px-8 border-t border-slate-200 dark:border-slate-700">
