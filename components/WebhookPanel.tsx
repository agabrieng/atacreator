...
const WebhookPanel: React.FC<WebhookPanelProps> = ({ webhooks, onAdd, onUpdate, onDelete }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6 space-y-4">
      <div className="space-y-3 pb-4 border-b dark:border-slate-700">
          <h3 className="text-lg font-semibold text-slate-700 dark:text-slate-300">Adicionar Novo Webhook</h3>
      ...
      <div className="pt-4">
          ...
          {webhooks.length === 0 ? (
              <p className="text-center text-sm text-slate-500 dark:text-slate-400 py-4">Nenhum webhook cadastrado.</p>
          ) : (
